...
export const AnnouncementBanner = () => {
  return (
    <div className="w-full bg-gradient-to-r from-pluto-purple to-pluto-light py-3 px-4">
      <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between text-white gap-3 sm:gap-0">
        ...
        <Button
          variant="secondary"
          className="bg-pluto-dark/20 hover:bg-pluto-dark/30 text-white rounded-full border-transparent"
        >
